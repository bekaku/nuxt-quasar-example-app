  ...
  <q-card :class="{ 'text-white': dark }" flat :dark>
    <slot name="toolbar">
      <q-toolbar>
        ...
        <BaseButton flat round dense @click="zoomOut">
          <BaseIcon name="hugeicons:zoom-out-area" icon-set="nuxt" />
          <BaseTooltip> Zoom-</BaseTooltip>
        </BaseButton>
        <BaseButton flat round dense @click="zoomIn">
          <BaseIcon name="hugeicons:zoom-in-area" icon-set="nuxt" />
          <BaseTooltip> Zoom+</BaseTooltip>
        </BaseButton>
        <template v-if="showArrow">
          <BaseButton flat dense round :disable="slide == 0" @click="onPrev()">
            <BaseIcon name="hugeicons:arrow-left-02" icon-set="nuxt" />
          </BaseButton>
          <BaseButton dense flat round :disable="slide == fileZise - 1" @click="onNext">
