                ...
                <q-form class="q-gutter-md" @submit="onSubmit">
                    <BaseCard>
                        <q-card-section class="q-gutter-sm">
                            ...
                            <BaseInput v-model="surname" :edit-mode="editMode" label="Surname" :rules="[required]"
                                avatar="https://cdn.quasar.dev/img/avatar2.jpg" />
                            <BaseInput v-model="email" :edit-mode="editMode" label="Email" :icon="biEnvelope"
                                :rules="[required, requireEmail]" clearable />
                            <BaseInput v-model="title" :edit-mode="editMode" label="Title" clearable counter
                                :maxlength="20">
                                <template #prepend>
                            ...
                            <ClientOnly>
                                <BaseInput v-model="amount" :edit-mode="editMode" label="Amount" type="number"
                                    :min="0" :max="10" hint="Limit 0 to 10" />
                                <BaseInput v-model="amount2" :edit-mode="editMode" label="Amount2" type="number"
                            ...
                            <BaseDatePicker v-model="pickDate" :edit-mode="editMode" label="Select Date" required />

                            <div class="text-h6">
                                Time picker
                            </div>
                            <BaseTimePicker v-model="pickTime" :edit-mode="editMode" label="Select time" required />


                            <div class="text-h6">
                                Text area
                            </div>
                            <BaseInput v-model="text" :edit-mode="editMode" label="Test area" placeholder="textarea"
                                type="textarea" :icon="biPencil" />
            ...
            <div class="col-12 col-md-6 q-pa-md">
                <BaseCard>
                    <q-card-section class="q-gutter-sm">
                        ...
                        <BaseInput v-model="name" :edit-mode="false" label="Name" :icon="biPerson" bottom-slots
                            ...
                            <template #append>
                                <BaseIcon class="cursor-pointer" icon-set="quasar"
                                    :icon="showPassword ? biEye : biEyeSlash" @click="showPassword = !showPassword" />
                            </template>
                            <template #after>
                                <BaseButton flat round :icon="biSend" />
                            </template>
                        </BaseInput>
                        <BaseInput v-model="surname" :edit-mode="false" label="Surname"
                            avatar="https://cdn.quasar.dev/img/avatar2.jpg" />
                        <BaseInput v-model="email" :edit-mode="false" label="Email" :icon="biEnvelope" clearable />
                        ...
                        <BaseInput v-model="amount" :edit-mode="false" label="Amount" type="number"
                            hint="Limit 0 to 10" :view-show-hint="false" />
                        <BaseInput v-model="amount2" :edit-mode="false" label="Amount2" type="number"
                            hint="Between 1 to 50" />
                        <div class="text-h6">
                            Money format
                        </div>
                        ...
                        <BaseInput v-model="text" :edit-mode="false" label="Test area" type="textarea"
                            :icon="biPencil" />
                    </q-card-section>
                </BaseCard>
            </div>
