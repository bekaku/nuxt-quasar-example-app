...
const { data: imageItems } = await useFetch<FileManager[]>('/api/mock/file/imageItemsData')
...
const { data: pdfItems } = await useFetch<FileManager[]>('/api/mock/file/pdfItemsData')
