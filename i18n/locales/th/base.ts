export default {
    base: {
        ...
        termAcceptText2: "ข้อกำหนดในการให้บริการ และ นโยบายความเป็นส่วนตัว ของ GiveDeeFive",
        continue: 'ต่อไป',
        previous: 'ก่อนหน้า',
        ...
        items: 'ไม่มีรายการ | {n} รายการ | {n} รายการ',
    ...
    drive: {
        ...
        documents: 'เอกสาร',
        audios: 'เสียง',
        searchFile: 'ค้นหาไฟล์',
        fileName: 'ชื่อ',
        createdDate: 'วันที่สร้าง',
        updatedDate: 'วันที่แก้ไข',
        fileSize: 'ขนาดไฟล์',
        fileMime: 'ชนิดไฟล์',
        uploadVideos: 'อัพโหลดไฟล์วิดีโอ',
        uploadAudios: 'อัพโหลดไฟล์เสียง',
        changName: 'เปลี่ยนชื่อ',
        ...
        viewsAmount: '{n} คนดู | {n} คนดู',
        view: 'คนดู',
        views: 'คนดู',
        donwloadingTitle: 'กำลังโหลดไฟล์ {0}',
        donwloadingTitle2: 'กรุณารอสักครู่จนกว่าการดาวน์โหลดจะเสร็จสิ้น',
        donwloadingTitle3: 'ความเร็ว: {speed}, {loaded}/{total}, {percent}%',
        downloadCancelled: 'การดาวน์โหลดถูกยกเลิก',
        cancelDownload: 'ยกเลิกดาวน์โหลด',
        download: 'ดาวน์โหลด',
    },
    theme: {
        light: 'กลางวัน',
