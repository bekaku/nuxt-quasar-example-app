export default {
    error: {
        ...
        validateRequireField: 'ข้อมูลนี้ต้องระบุ',
        validateRequirePwd: 'ข้อมูลนี้ต้องระบุ ต้องผสมด้วยตัวเลขและตัวอักษร',
        ...
        limitEachFile2: 'ขออภัยไม่สามารถอัพโหลดไฟล์ {0} ได้เนื่องจากมีขนาดเกิน {1} MB!',
